...
public class BankServiceTest {
    ...
    public void findByPassport() {
        ...
        User user = new User("1234", "Bog");
        bankService.addUser(user);
        assertThat(bankService.findByPassport("1234").get(), is(user));
    }

    @Test
    public void findByRequisite() {
        BankService bank = new BankService();
        User user = new User("123", "Bogdan");
        bank.addUser(user);
        Account account = new Account("456", 9999D);
        bank.addAccount("123", account);
        assertThat(bank.findByRequisite("123", "456").get(), is(account));
    }
}